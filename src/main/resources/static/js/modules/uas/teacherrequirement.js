$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '联系人性别(0:男,1:女)', name: 'sex', index: 'sex', width: 80 ,formatter:showSex},
			...
			{ label: '学员状态(0:零基础,1:补差型,2:提高型,3:拔尖型)', name: 'studentLevel', index: 'student_level', width: 80, formatter:showStudentLevel},
			{ label: '授课时间', name: 'teachingTime', index: 'teaching_time', width: 80 }, 			
			{ label: '需求人数', name: 'requireCount', index: 'require_count', width: 80 }, 			
			{ label: '性别要求(0:男，1：女,2:无要求)', name: 'requireSex', index: 'require_sex', width: 80 ,formatter:showSex},
			{ label: '身份要求（0：在职教员，1：在职教师，2：无）', name: 'identity', index: 'identity', width: 80,formatter:showidentity },
			...
			{ label: '乘车补贴（0：无，1：有，2：部分，3：协商）', name: 'ridingAllowance', index: 'riding_allowance', width: 80,formatter:showRidingAllowance},
			{ label: '发布时间', name: 'releaseTime', index: 'release_time', width: 80 ,formatter:getMyDateTime},
			{ label: '发布状态（0：发布中，1：已关闭)', name: 'releaseStatus', index: 'release_status', width: 80,formatter:showReleaseStatus}
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
