$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'generator/admin/list',
        datatype: "json",
        colModel: [			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.admin.id == null ? "generator/admin/save" : "generator/admin/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		del: function (event) {
			...
			confirm('确定要删除选中的记录？', function(){
				$.ajax({
					type: "POST",
				    url: baseURL + "generator/admin/delete",
                    contentType: "application/json",
		...
		getInfo: function(id){
			$.get(baseURL + "generator/admin/info/"+id, function(r){
                vm.admin = r.admin;
            });
		},
